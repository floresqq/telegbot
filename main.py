...
import telebot
import random
bot = telebot.TeleBot('1244820992:AAF-AZIRQNPbPGMYmrxCPWWGGzMqblA3smY')
...
def get_text_messages(message):
    ...
    if message.text == "/help":
        ...
        bot.send_message(message.from_user.id, "Этот бот рассказывает гороскоп на сегодня. Команда /horoscope")
